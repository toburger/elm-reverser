...
Elm.App = Elm.App || {};
Elm.App.Main = Elm.App.Main || {};
Elm.App.Main.make = function (_elm) {
   "use strict";
   _elm.App = _elm.App || {};
   _elm.App.Main = _elm.App.Main || {};
   if (_elm.App.Main.values) return _elm.App.Main.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Dict = Elm.Dict.make(_elm),
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var dispatchReset = Elm.Native.Port.make(_elm).inboundSignal("dispatchReset",
   "()",
   function (v) {
      return typeof v === "object" && v instanceof Array ? {ctor: "_Tuple0"} : _U.badPort("an array",
      v);
   });
   var textStyle = F2(function (mapping,c) {
      return A2($Maybe.map,
      function (c) {
      ...
      A2($Dict.get,c,mapping));
   });
   var colorMappingsView = function (colorMappings) {
      return A2($Html.dl,
      _U.list([]),
      A2($List.concatMap,
      function (_p0) {
         ...
         return _U.list([A2($Html.dt,
                        _U.list([]),
                        _U.list([$Html.text($String.fromChar(_p1._0))]))
                        ,A2($Html.dd,
   ...
   var stringView = F2(function (mapping,txt) {
      return A2($Html.div,
      _U.list([]),
      A2($List.map,
      function (c) {
   ...
   var onInput = F2(function (address,action) {
      ...
      function (_p3) {
         return A2($Signal.message,address,action(_p3));
      });
   });
   var AddColorMapping = {ctor: "AddColorMapping"};
   var UpdateSelectedColor = function (a) {
      return {ctor: "UpdateSelectedColor",_0: a};
   };
   var UpdateSelectedChar = function (a) {
      return {ctor: "UpdateSelectedChar",_0: a};
   };
   var addColorMappingView = F3(function (address,
   selectedChar,
   selectedColor) {
      var charOrEmpty = A2($Maybe.withDefault,
      "",
      A2($Maybe.map,$String.fromChar,selectedChar));
      var cannotAdd = _U.eq(selectedColor,"") || _U.eq(selectedChar,
      $Maybe.Nothing);
      return A2($Html.fieldset,
      _U.list([$Html$Attributes.$class("fieldset")]),
      _U.list([A2($Html.label,
              _U.list([]),
              _U.list([$Html.text("char")
                      ,A2($Html.input,
                      _U.list([$Html$Attributes.type$("text")
                              ,A2(onInput,
                              address,
                              function (_p4) {
                                 return UpdateSelectedChar(firstChar(_p4));
                              })
                              ,$Html$Attributes.value(charOrEmpty)]),
                      _U.list([]))]))
              ,A2($Html.label,
              _U.list([]),
              _U.list([$Html.text("color")
                      ,A2($Html.input,
                      _U.list([$Html$Attributes.type$("text")
                              ,A2(onInput,address,UpdateSelectedColor)
                              ,$Html$Attributes.value(selectedColor)]),
                      _U.list([]))]))
              ,A2($Html.button,
              _U.list([$Html$Attributes.disabled(cannotAdd)
                      ,A2($Html$Events.onClick,address,AddColorMapping)
                      ,$Html$Attributes.classList(_U.list([{ctor: "_Tuple2"
                                                           ,_0: "button"
                                                           ,_1: true}
                                                          ,{ctor: "_Tuple2",_0: "expanded",_1: true}
                                                          ,{ctor: "_Tuple2",_0: "disabled",_1: cannotAdd}]))]),
   ...
   var textInput = F2(function (address,text) {
      return A2($Html.fieldset,
      _U.list([$Html$Attributes.$class("fieldset")]),
      _U.list([A2($Html.input,
              _U.list([$Html$Attributes.type$("text")
                      ,$Html$Attributes.value(text)
                      ,A2(onInput,address,UpdateText)]),
              _U.list([]))
              ,A2($Html.button,
              _U.list([A2($Html$Events.onClick,address,Reset)
                      ,$Html$Attributes.disabled(_U.eq(text,""))
                      ,$Html$Attributes.classList(_U.list([{ctor: "_Tuple2"
                                                           ,_0: "button"
                                                           ,_1: true}
                                                          ,{ctor: "_Tuple2",_0: "expanded",_1: true}
                                                          ,{ctor: "_Tuple2",_0: "warning",_1: true}
                                                          ,{ctor: "_Tuple2",_0: "disabled",_1: _U.eq(text,"")}]))]),
              _U.list([$Html.text("reset")]))]));
   });
   var view = F2(function (address,_p5) {
      var _p6 = _p5;
      var _p8 = _p6.text;
      var _p7 = _p6.colorMappings;
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("medium-6 medium-centered large-4 large-centered columns")]),
      _U.list([A2($Html$Lazy.lazy,textInput(address),_p8)
              ,A2($Html.hr,_U.list([]),_U.list([]))
              ,A2($Html.h5,_U.list([]),_U.list([$Html.text("output:")]))
              ,A3($Html$Lazy.lazy2,stringView,_p7,_p8)
              ,A3($Html$Lazy.lazy2,stringView,_p7,_p6.reversedText)
              ,A2($Html.hr,_U.list([]),_U.list([]))
              ,A2($Html$Lazy.lazy,colorMappingsView,_p7)
              ,A4($Html$Lazy.lazy3,
              addColorMappingView,
              address,
              _p6.selectedChar,
   ...
   var initialModel = {text: ""
                      ,reversedText: ""
                      ,colorMappings: $Dict.fromList(_U.list([{ctor: "_Tuple2"
                                                              ,_0: _U.chr("a")
                                                              ,_1: "red"}
                                                             ,{ctor: "_Tuple2",_0: _U.chr("b"),_1: "blue"}]))
                      ,selectedChar: $Maybe.Nothing
                      ,selectedColor: ""};
   var update = F2(function (action,model) {
      var _p9 = action;
      switch (_p9.ctor)
      {case "UpdateText": var _p10 = _p9._0;
           return {ctor: "_Tuple2"
                  ,_0: _U.update(model,
                  {text: _p10,reversedText: $String.reverse(_p10)})
                  ,_1: $Effects.none};
         case "Reset": return {ctor: "_Tuple2"
                              ,_0: initialModel
                              ,_1: $Effects.none};
         case "UpdateSelectedChar": if (_p9._0.valueOf() === " ") {
                 return {ctor: "_Tuple2"
                        ,_0: _U.update(model,{selectedChar: $Maybe.Nothing})
                        ,_1: $Effects.none};
              } else {
                 return {ctor: "_Tuple2"
                        ,_0: _U.update(model,{selectedChar: $Maybe.Just(_p9._0)})
                        ,_1: $Effects.none};
              }
         case "UpdateSelectedColor": return {ctor: "_Tuple2"
                                            ,_0: _U.update(model,{selectedColor: _p9._0})
                                            ,_1: $Effects.none};
         default: var _p11 = {ctor: "_Tuple2"
                             ,_0: model.selectedChar
                             ,_1: model.selectedColor};
           if (_p11.ctor === "_Tuple2" && _p11._0.ctor === "Just") {
                 return {ctor: "_Tuple2"
                        ,_0: _U.update(model,
                        {colorMappings: A3($Dict.insert,
                        _p11._0._0,
                        _p11._1,
                        model.colorMappings)
                        ,selectedChar: $Maybe.Nothing
   ...
   return _elm.App.Main.values = {_op: _op
                                 ,Model: Model
                                 ...
                                 ,AddColorMapping: AddColorMapping
                                 ,update: update
                                 ,onInput: onInput
                                 ,stringView: stringView
                                 ,firstChar: firstChar
                                 ,addColorMappingView: addColorMappingView
                                 ,colorMappingsView: colorMappingsView
                                 ,textInput: textInput
                                 ,view: view
                                 ,textStyle: textStyle
                                 ,app: app
